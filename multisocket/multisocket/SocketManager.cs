...
namespace Socket
{
    ...
    class SocketManager
    {
        ...
        //Host
        public Thread[] _clientThreads = new Thread[0];
        public TcpClient[] _clients = new TcpClient[0];
        ...
        public void SendMessageToAllClientsExpectClient(string message, TcpClient cl)
        {
            if (!Connected)
                return;
            if (!_isHost)
        ...
        public void StartListenClients()
        {
            while (true)
            {
                try
